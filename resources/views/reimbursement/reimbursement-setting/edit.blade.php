<div class="modaleditreimbursementsetting ri2-modal ri2-fixed ri2-fullwidth ri2-fullheight">
    <div class="ri2-table ri2-fullwidth ri2-fullheight ri2-relative">
        <div class="ri2-cell ri2-center ri2-vmid ri2-boxpad20 ri2-box">
            <div
                class="modaleditreimbursementsettingback ri2-modal-back ri2-absolute ri2-fullwidth ri2-fullheight"></div>
            <div class="ri2-modal-content ri2-relative new-modal-content">
                <div
                    ...
                    <div
                        ...
                        Edit Reimbursement Setting
                    </div>
                    <form method="post" id="editReimbursementSettings" class="form-horizontal"
                          enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" id="reimbursementSettingsEditId" name="reimbursementSettingsEditId">
                        <div class="ri2-block ri2-relative ri2-boxpad40 ri2-mobileboxpad20 ri2-box">
                            <div class="ri2-block ri2-relative ri2-marginbottom20 ri2-left">
                                ...
                                <div class="ri2-block ri2-relative">
                                    <select
                                        ...
                                        name="reimbursement_id" style="width: 100%;" id="reimbursement_id">
                            ...
                            <div class="ri2-block ri2-relative ri2-marginbottom20 ri2-left">
                                ...
                                <div class="ri2-block ri2-relative ri2-checkbox ri2-marginbottom5">
                                    <label
                                        ...
                                        <input type="checkbox" name="set_default"  value="1" id="set_default">
                                ...
                                <div class="ri2-block ri2-relative ri2-checkbox ri2-marginbottom5">
                                    <label
                                        class="ri2-checkbox-container ri2-txblack3 ri2-paddingleft30 ri2-pointer ri2-font14 ri2-line14">
                                        <input type="checkbox" name="emerge_at_join" value="1" id="emerge_at_join">
                                ...
                                <div class="ri2-block ri2-relative ri2-checkbox ri2-marginbottom5">
                                    <label
                                        class="ri2-checkbox-container ri2-txblack3 ri2-paddingleft30 ri2-pointer ri2-font14 ri2-line14">
                                        <input type="checkbox"  name="mandatory_upload_file" value="1" id="mandatory_upload_file">
                            ...
                            <div class="ri2-block ri2-relative ri2-left ri2-margintop20">
                                <button
                                    class="modaleditreimbursementsettingclose ri2-inlineblock ri2-bordernone ri2-borderradius2 ri2-boxpad7 ri2-paddingright15 ri2-paddingleft15 ri2-bgblue1 ri2-txwhite1 ri2-hovering ri2-font16 ri2-semibold ri2-pointer">
                                    Simpan
                                </button>
                                <button
                                    class="modaleditreimbursementsettingclose ri2-inlineblock ri2-bordernone ri2-borderradius2 ri2-boxpad7 ri2-paddingright15 ri2-paddingleft15 ri2-bgwhite5 ri2-txblack3 ri2-hovering ri2-font16 ri2-semibold ri2-pointer">
                                    Batal
                                </button>
                            </div>
                        </div>
                ...
                <div class="ri2-block ri2-relative ri2-center">
                    <div
                        class="modaleditreimbursementsettingclose ri2-inlineblock ri2-relative ri2-modal-close ri2-txwhite1 ri2-semibold ri2-font18 ri2-pointer ri2-linkhoveryellow1">
